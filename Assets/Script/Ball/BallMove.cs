    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
       if (state == BallState.Battle) //如果在战斗阶段
       {
          ...
          if (collision.gameObject.tag == "Enemy") //如果碰到敌人    
          {
            ...
            iTween.ShakePosition(collision.gameObject,new Vector3(0,0.1f,0),0.3f);
            //  iTween.MoveBy(collision.gameObject, iTween.Hash("x", 0.1, "easeType", iTween.EaseType.easeInCubic, "loopType", iTween.LoopType.pingPong, "delay", 0.01));
             //获取敌人数字
